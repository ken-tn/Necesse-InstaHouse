...
public class InstaHousePreset extends Preset {
    ...
    public InstaHousePreset() {
        super(InstaHouseMod.SettingsGetter.getBoolean("client_preset_allowed") ? InstaHouseMod.SettingsGetter.getString("preset") : InstaHouseMod.SettingsGetter.getString("server_preset"));
    }
}
